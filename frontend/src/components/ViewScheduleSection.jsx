    ...
    <div className="">
        ...
        <div className="flex">
            ...
            <div className="basis-3/5 my-5">
                ...
                <Accordion loading={loading} data={data} yourTeamSchedule={yourTeamSchedule} yourSchedule={yourSchedule} activeSchedule={activeSchedule} isManageOwnApplication={isManageOwnApplication}/>
            </div>
